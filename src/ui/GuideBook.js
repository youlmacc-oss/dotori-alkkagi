...
export const GUIDE_PAGES = Object.freeze([
  ...
  Object.freeze({
    ...
    points: ['1인: 흑·백 모두 나 · 호스트(흑)가 먼저', 'AI: 위는 봇, 아래는 나', '1:1: 동전으로 선공 · 사람이 들어올 때까지 대기', '호스트는 흑, 초대 입장은 백', '다시하기는 같은 방 · 같은 상대 · 동전은 다시'],
  }),
  Object.freeze({
    id: 'ready',
    kicker: '시작 전',
    ...
    points: ['예를 누르면 10초 동안 첫째 선 안에서 자기 진영 돌을 옮깁니다', '10부터 1까지 내려가며 셉니다', '아니오·무응답이면 시작 버튼을 기다립니다', '⚙️에서 재배치를 끄면 시작 버튼이 바로 나옵니다'],
  }),
  Object.freeze({
    id: 'acorn',
    kicker: '선공 · 도토리',
    title: '동전으로 먼저',
    visual: 'acorn',
    lead: '1:1 선공은 도토리 금화(앞뒤 반반). 도토리는 시작 10, 승 +1 / 패 −1.',
    points: ['앞면(갓·구름)은 방장(흑), 뒷면(몸통·금테)은 손님(백)', '같은 방이면 양쪽이 같은 선공을 봅니다', '다시하기면 동전을 다시 던집니다', '선공이 시작 버튼을 누릅니다. 도토리봇이 나와도 사람이 시작합니다', '1인은 호스트(흑)가 먼저입니다', '1인·설정 AI 연습·관람은 도토리를 건드리지 않습니다', '도토리봇 1:1은 사람과 같이 ±1이며 봇 도토리는 계속 남습니다', '창을 닫거나 끊겨도 시작된 1:1은 기권승으로 정산합니다', '같은 탭에서 F5를 눌러도 닉과 도토리는 남습니다'],
  }),
  Object.freeze({
    id: 'fall',
    kicker: '승패',
